void encoder(){
  //this will print out the left motors encoder readings
  // if it goes ccw then it increments
  // if it goes cw then it decrements
  // ccw correlates with forward motion and cw with reverse motion
  // forward is discribed as the direction in which the "front" sonar is facing
...
void sonar(){
  ...
  /////////////////////////////////////////////
  // this is for filtering out the values that are known to be wrong
  if (distance1 <= 400 ){
...
//  delay(200);
  ...
  //print out the info on the bluetooth
